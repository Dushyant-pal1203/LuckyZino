...
import { MainSection } from '@/components/lp/v5/MainSection';
import { DividerSection } from '@/components//lp/v5/DividerSection';
import { ClaimSection } from '@/components//lp/v5/ClaimSection';
    ...
    <>
      ...
      <noscript>
        ...
        <img
          ...
          width="1"
          style={{ display: 'none' }}
          src="https://www.facebook.com/tr?id=3986948894876568&ev=PageView&noscript=1"
          alt="fb-pixel"
        />
      </noscript>
