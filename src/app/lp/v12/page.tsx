...
import { ExclusiveSectionThree } from '@/components//lp/v12/ExclusiveSectionThree';
...
import styles from '@/styles/pages/pageV12.module.scss';
...
export default function Home() {
  return (
    <>
      ...
      <div id="landingPageV12" className={styles.landingPageV12}>
        <Header />
        <VideoSection />
        <div className={styles.centerSectionBG}>
          <ExclusiveSectionThree />
          <BonusSlider customClassName="testimonialsSliderV12" />
          <AmazingGamesSlider />
          <ProvidersSlider />
        </div>
        <BenefitSection />
        <TestimonialsSlider customClassName="testimonialsSliderV12" />
        <Footer />
        <ActionSection />
        <HelpshiftStyles />
      </div>
