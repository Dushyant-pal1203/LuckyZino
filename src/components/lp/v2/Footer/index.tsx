...
export const Footer = () => {
  ...
  const [modalPage, setModalPage] = useState<null | 'terms' | 'privacy' | 'rules' | 'responsible' | 'cookie'>(null);
  ...
  return (
    <footer className="bg-[#6929D8] text-white py-[8px] font-['Exo_2']">
      <div className="md:flex md:justify-between mx-auto py-[16px] px-[24px] max-w-[1120px] gap-[24px]">
        ...
        <div className="hidden md:flex md:flex-col md:justify-center flex-shrink-0">
          <div className="flex justify-center items-center mb-4">
            <img className="max-w-[240px]" src="/images/logo-gray.png" alt='logo' />
          </div>
          <p className="text-[14px] opacity-90">&copy; {currentYear} Silver Rhino LTD. All rights reserved.</p>
        </div>
        ...
        <div className="md:hidden">
          ...
          <div className="grid grid-cols-2 gap-y-4 gap-x-8 mb-6 text-[16px]">
            ...
            <div className="flex space-x-3">
              <Link href="https://www.facebook.com/profile.php?id=61574664105322"
                target='_blank' className="hover:opacity-80 transition-opacity">
                <div className="w-8 h-8 min-w-[36px] min-h-[36px] flex items-center justify-center">
                  <img src="/images/fb.png" alt='fb logo' />
                </div>
              </Link>
              <Link href="https://www.instagram.com/lucky_zino_official/"
                className="hover:opacity-80 transition-opacity"
                target='_blank'>
                <div className="w-8 h-8 min-w-[36px] min-h-[36px] flex items-center justify-center">
                  <img src="/images/inst.png" alt='instagram logo' />
          ...
          <div className="text-center mb-6">
            <div className="flex items-center justify-center mb-3">
              <div className="bg-white text-purple-600 font-bold text-[24px] px-[12px] py-[4px] mr-[8px] transform -skew-x-12">
                LZ
              </div>
              <span className="text-[30px] font-bold italic">LuckyZino</span>
            </div>
            <p className="text-[14px] opacity-90 mb-4">&copy; {currentYear} Silver Rhino LTD. All rights reserved.</p>
          </div>
